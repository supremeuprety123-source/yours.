      ...
      <div className="rounded-2xl border border-zinc-800 bg-[#1A1A1A] p-5">
        ...
        <div className="grid grid-cols-7 gap-1">
          ...
          {Array.from({ length: daysInMonth }).map((_, i) => {
            ...
            return (
              <div key={day} className={`aspect-square rounded-lg flex flex-col items-center justify-center text-xs ${isToday ? 'border border-[#C8A96E]/40' : ''} ${entry ? '' : 'bg-zinc-900/30'}`} style={entry ? { background: `${['#C0392B','#E07B39','#71717a','#4CAF7D','#C8A96E'][entry.mood - 1]}20` } : {}}>
